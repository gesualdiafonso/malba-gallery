...
<section>
    <h2 class="form-title">Envios a todo el pais</h2>
    <div>
    ...
    <div class="uk-padding-medium uk-padding-remove-vertical">
        <p class="uk-text-large uk-margin-small-top">En aras de la seguridad de nuestros autores y de sus derechos artísticos, le informamos de que la venta de sus obras está sujeta a una escala de usuarios.</p>
        <p class="uk-text-large uk-margin-small-top">Le rogamos que rellene concienzudamente nuestro formulario y a continuación le indicaremos los pasos a seguir antes de su aprobación.</p>
        <span class="uk-text-default uk-margin-medium-top">¡La creación de esta curadoría es de sumo necesario!</span>
    </div>
